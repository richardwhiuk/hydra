...
Hydra::Apache2::Client::Client(boost::asio::io_service& io_service, const Hydra::request& req, Hydra::reply& rep, const std::string& server, const std::string& port) : m_resolver(io_service), m_socket(io_service), m_reply(rep){
	...
	m_resolver.async_resolve(query,
		boost::bind(&Hydra::Apache2::Client::handle_resolve, this,
...
void Hydra::Apache2::Client::handle_resolve(const boost::system::error_code& err, boost::asio::ip::tcp::resolver::iterator endpoint_iterator){
	if (!err){
		// Attempt a connection to the first endpoint in the list. Each endpoint
		// will be tried until we successfully establish a connection.
		boost::asio::ip::tcp::endpoint endpoint = *endpoint_iterator;
		m_socket.async_connect(endpoint,
				boost::bind(&Hydra::Apache2::Client::handle_connect, this,
...
void Hydra::Apache2::Client::handle_connect(const boost::system::error_code& err, boost::asio::ip::tcp::resolver::iterator endpoint_iterator){ 
	if (!err){
		// The connection was successful. Send the request.
		boost::asio::async_write(m_socket, m_request,
				boost::bind(&Hydra::Apache2::Client::handle_write_request, this,
					boost::asio::placeholders::error));
...
void Hydra::Apache2::Client::handle_write_request(const boost::system::error_code& err){
	if (!err){
		// Read the response status line.
		boost::asio::async_read_until(m_socket, m_response, "\r\n",
				boost::bind(&Hydra::Apache2::Client::handle_read_status_line, this,
					boost::asio::placeholders::error));
	} else {
...
void Hydra::Apache2::Client::handle_read_status_line(const boost::system::error_code& err){
	if (!err){
		...
		boost::asio::async_read_until(m_socket, m_response, "\r\n\r\n",
				boost::bind(&Hydra::Apache2::Client::handle_read_headers, this,
					boost::asio::placeholders::error));
	} else {
...
void Hydra::Apache2::Client::handle_read_headers(const boost::system::error_code& err){
	if (!err){
		...
		boost::asio::async_read(m_socket, m_response,
				...
				boost::bind(&Hydra::Apache2::Client::handle_read_content, this,
					boost::asio::placeholders::error));
	} else {
...
void Hydra::Apache2::Client::handle_read_content(const boost::system::error_code& err){
